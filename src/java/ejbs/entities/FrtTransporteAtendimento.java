 ...
 */
@Entity
@Table(name = "frt_transporte_atendimento")
@XmlRootElement
@NamedQueries(
{
...
public class FrtTransporteAtendimento implements Serializable
{
    ...
    @Column(name = "pk_transporte_atendimento")
    ...
    @Column(name = "quilometro_inicial")
    ...
    @Size(max = 2147483647)
    @Column(name = "quilometro_final")
    private String quilometroFinal;
    @Size(max = 2147483647)
    @Column(name = "percurso_percorrido")

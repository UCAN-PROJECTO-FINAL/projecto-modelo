...
public class GrlPessoa implements Serializable
{
    ...
    @Size(max = 2147483647)
    @Column(name = "rua_casa")
    private String ruaCasa;
    @Size(max = 2147483647)
    @Column(name = "comentario_sexo")
    private String comentarioSexo;
    @Size(max = 2147483647)
    @Column(name = "comentario_data_nascimento")
    private String comentarioDataNascimento;
    @Size(max = 2147483647)
    @Column(name = "comentario_email")
    private String comentarioEmail;
    @Size(max = 2147483647)
    @Column(name = "comentario_telefone")
    private String comentarioTelefone;
    @Size(max = 2147483647)
    @Column(name = "comentario_nome")
    private String comentarioNome;
    @Size(max = 2147483647)
    @Column(name = "comentario_numero_identificacao")

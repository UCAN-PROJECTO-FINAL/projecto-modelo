 ...
 */
@Entity
@Table(name = "seg_perfil_associado")
@XmlRootElement
@NamedQueries(
{
...
public class SegPerfilAssociado implements Serializable
{
    ...
    @JoinColumn(name = "id_perfil_filho", referencedColumnName = "pk_seg_perfil", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private SegPerfil segPerfil;
    @JoinColumn(name = "id_perfil_pai", referencedColumnName = "pk_seg_perfil", insertable = false, updatable = false)
    @ManyToOne(optional = false)

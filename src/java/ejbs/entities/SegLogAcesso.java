...
public class SegLogAcesso implements Serializable
{
    ...
    @Column(name = "pk_seg_log_acesso")
    private Integer pkSegLogAcesso;
    @Size(max = 2147483647)
    @Column(name = "evento_log_acesso")
    private String eventoLogAcesso;
    @Size(max = 2147483647)
    @Column(name = "risco_log_acesso")
    ...
    @Size(max = 2147483647)
    @Column(name = "ip_log_acesso")
    private String ipLogAcesso;
    @Size(max = 2147483647)
    @Column(name = "resultado_log_acesso")
    private String resultadoLogAcesso;
    @Size(max = 2147483647)
    @Column(name = "detalhes_log_acesso")

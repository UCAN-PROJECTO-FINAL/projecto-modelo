 ...
 * @author samuel
 */
@Named(value = "transporteManutencaoCadastrarBean")
@ViewScoped
public class TransporteManutencaoCadastrarBean implements Serializable
{
    @EJB
     ...
     */
    public TransporteManutencaoCadastrarBean() 
    {

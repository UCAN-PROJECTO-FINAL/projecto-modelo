...
@SessionScoped
public class TransporteAtendimentoBean implements Serializable
{
     ...
     */
    public TransporteAtendimentoBean()
    {
...
//    
  ...
  //          userTransaction.begin();
            ...
            frtTransporteSolicitacao.setFkTransporteSolicitacaoEstaso(new FrtTransporteSolicitacaoEstado(2));
    ...
    public void finalizarAtendimento()
    {
        ...
        frtTransporteSolicitacao.setFkTransporteSolicitacaoEstaso(new FrtTransporteSolicitacaoEstado(3));
        frtTransporteSolicitacaoFacade.edit(frtTransporteSolicitacao);

        frtTransporteSolicitacaoEstado.setPkTransporteSolicitacaoEstado(3);
        frtTransporteAtendimento.setFkTransporteAtendimentEstado(frtTransporteSolicitacaoEstado);

...
@SessionScoped
public class GrlTipoSolicitacaoCadastrarBean implements Serializable
{

    @EJB
    private GrlTipoSolicitacaoFacade solicitacaoFacade;

    private GrlTipoSolicitacao solicitacao;
     ...
     */
    public GrlTipoSolicitacaoCadastrarBean()
    {
    ...
    public void init()
    {
        ...
        solicitacao = new GrlTipoSolicitacao();
    }
    ...
    public String gravar()
    {
        try
        {
            ...
            {
                this.solicitacao = new GrlTipoSolicitacao();
            ...
            //solicitacao.setPkTipoSolicitacao(solicitacaoFacade.codigo());
            this.solicitacaoFacade.create(this.solicitacao);
            init();
    ...
    {
        return this.solicitacaoFacade.findTipoSolicitacaoByDescricao(this.solicitacao.getDescricao());
    }

    public String alterar(GrlTipoSolicitacao solicitacao)
    {
    ...
    public void editar()
    {
        ...
        try
        {
            ...
            this.solicitacaoFacade.edit(this.solicitacao);
            init();
    ...
    public void eliminar(GrlTipoSolicitacao solicitacao)
    {
        try
        {
            solicitacaoFacade.remove(solicitacaoFacade.find(solicitacao.getPkTipoSolicitacao()));
    ...
    public List<GrlTipoSolicitacao> listaSolicitacao()
    {
        return this.solicitacaoFacade.findAll();
    }

    public GrlTipoSolicitacao getSolicitacao()
    {
        return solicitacao;
    }

    public void setSolicitacao(GrlTipoSolicitacao solicitacao)
    {
        this.solicitacao = solicitacao;
    }

 ...
 * @author smakambo
 */
@Named(value = "transporteFuncionarioEstadoCivilCadastrarBean")
@SessionScoped
public class FrtTransporteFuncionarioEstadoCivilCadastrarBean implements Serializable
{
    @EJB
    ...
    /**
     * Creates a new instance of TransporteFuncionarioEstadoCivilCadastrarBean
     */
    public FrtTransporteFuncionarioEstadoCivilCadastrarBean()
    {
    ...
    public String gravar()
    {
        try
        {
            ...
            {
                this.grlEstadoCivil = new GrlEstadoCivil();
            ...
            //grlEstadoCivil.setPkTipoSolicitacao(grlEstadoCivilFacade.codigo());
            this.grlEstadoCivilFacade.create(this.grlEstadoCivil);
            init();
    ...
    {
        return this.grlEstadoCivilFacade.findEstadoCivilByDescricao(this.grlEstadoCivil.getNome());
    }

    public String alterar(GrlEstadoCivil grlEstadoCivil)
    {
    ...
    public void editar()
    {
        ...
        try
        {
            ...
            this.grlEstadoCivilFacade.edit(this.grlEstadoCivil);
            init();
    ...
    public void eliminar(GrlEstadoCivil grlEstadoCivil)
    {
        try
        {
            grlEstadoCivilFacade.remove(grlEstadoCivilFacade.find(grlEstadoCivil.getPkGrlEstadoCivil()));
    ...
    public List<GrlEstadoCivil> listaEstadoCivil()
    {
        return this.grlEstadoCivilFacade.findAll();
    }
    
    

    public GrlEstadoCivil getSolicitacao()
    {
        return grlEstadoCivil;
    }

    public void setSolicitacao(GrlEstadoCivil grlEstadoCivil)
    {
        this.grlEstadoCivil = grlEstadoCivil;
    }

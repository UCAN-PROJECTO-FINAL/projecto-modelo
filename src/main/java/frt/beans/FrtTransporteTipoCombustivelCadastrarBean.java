...
@SessionScoped
public class FrtTransporteTipoCombustivelCadastrarBean implements Serializable
{
    
    @EJB
    private FrtTransporteTipoCombustivelFacade ftTransporteTipoCombustivelFacade;
    ...
    public FrtTransporteTipoCombustivelCadastrarBean()
    {
    ...
    public String gravar()
    {
        try
        {
            ...
            //frtTransporteTipoCombustivel.setPkTipoSolicitacao(ftTransporteTipoCombustivelFacade.codigo());
            this.ftTransporteTipoCombustivelFacade.create(this.frtTransporteTipoCombustivel);
            init();
    ...
    {
        return this.ftTransporteTipoCombustivelFacade.findTipoComustivelByDescricao(this.frtTransporteTipoCombustivel.getDescricao());
    }

    public String alterar(FrtTransporteTipoCombustivel frtTransporteTipoCombustivel)
    {
    ...
    public void editar()
    {
        ...
        try
        {
            ...
            this.ftTransporteTipoCombustivelFacade.edit(this.frtTransporteTipoCombustivel);
            init();
    ...
    public void eliminar(FrtTransporteTipoCombustivel frtTransporteTipoCombustivel)
    {
        try
        {
            ftTransporteTipoCombustivelFacade.remove(ftTransporteTipoCombustivelFacade.find(frtTransporteTipoCombustivel.getPkTipoCombustivel()));
    ...
    public List<FrtTransporteTipoCombustivel> listaTipoCombustivel()
    {
        return this.ftTransporteTipoCombustivelFacade.findAll();
    }

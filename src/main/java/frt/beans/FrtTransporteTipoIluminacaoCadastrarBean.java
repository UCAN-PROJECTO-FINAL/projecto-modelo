 ...
 * @author smakambo
 */
@Named(value = "transporteTipoIluminacaoCadastrarBean")
@SessionScoped
public class FrtTransporteTipoIluminacaoCadastrarBean implements Serializable
{
    
    @EJB
    private FrtTransporteTipoIluminacaoFacade frtTransporteTipoInfraccaoFacade;

    private FrtTransporteTipoIluminacao frtTransporteTipoInfraccao;
    ...
    /**
     * Creates a new instance of TransporteTipoIluminacaoCadastrarBean
     */
    public FrtTransporteTipoIluminacaoCadastrarBean()
    {
    ...
    public void init()
    {
        ...
        frtTransporteTipoInfraccao = new FrtTransporteTipoIluminacao();
    }
    ...
    public String gravar()
    {
        try
        {
            ...
            {
                this.frtTransporteTipoInfraccao = new FrtTransporteTipoIluminacao();
    ...
    public List<FrtTransporteTipoIluminacao> verificarRegistro()
    {
        return this.frtTransporteTipoInfraccaoFacade.findTipoIluminacaoByDescricao(this.frtTransporteTipoInfraccao.getDescricao());
    }

    public String alterar(FrtTransporteTipoIluminacao frtTransporteTipoInfraccao)
    {
    ...
    public void eliminar(FrtTransporteTipoIluminacao frtTransporteTipoInfraccao)
    {
        try
        {
            frtTransporteTipoInfraccaoFacade.remove(frtTransporteTipoInfraccaoFacade.find(frtTransporteTipoInfraccao.getPkTipoIluminacao()));
    ...
    public List<FrtTransporteTipoIluminacao> listaTipoInfracao()
    {
        return this.frtTransporteTipoInfraccaoFacade.findAll();
    }

    public FrtTransporteTipoIluminacao getFrtTransporteTipoInfraccao()
    {
        return frtTransporteTipoInfraccao;
    }

    public void setFrtTransporteTipoInfraccao(FrtTransporteTipoIluminacao frtTransporteTipoInfraccao)
    {
        this.frtTransporteTipoInfraccao = frtTransporteTipoInfraccao;
    }

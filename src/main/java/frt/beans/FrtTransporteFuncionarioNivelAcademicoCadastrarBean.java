 ...
 * @author smakambo
 */
@Named(value = "transporteFuncionarioNivelAcademicoCadastrarBean")
@SessionScoped
public class FrtTransporteFuncionarioNivelAcademicoCadastrarBean implements Serializable
{
     ...
     * TransporteFuncionarioNivelAcademicoCadastrarBean
     */
    public FrtTransporteFuncionarioNivelAcademicoCadastrarBean()
    {
    ...
    public String gravar()
    {
        try
        {
            ...
            //rhNivelAcademico.setPkTipoSolicitacao(rhNivelAcademicoFacade.codigo());
    ...
    {
        return this.rhNivelAcademicoFacade.findRhNivelAcademicoByDescricao(this.rhNivelAcademico.getDescricao());
    }

    public String alterar(RhNivelAcademico rhNivelAcademico)
    {
    ...
    public void eliminar(RhNivelAcademico rhNivelAcademico)
    {
        try
        {
            rhNivelAcademicoFacade.remove(rhNivelAcademicoFacade.find(rhNivelAcademico.getPkNivelAcademico()));
    ...
    public List<RhNivelAcademico> listaSolicitacao()
    {
        return this.rhNivelAcademicoFacade.findAll();
    }

 ...
 * @author majoao
 */
@Named(value = "despesaCategoriaBean")
@ViewScoped
public class DespesaCategoriaBean implements Serializable {

    /**
     * Creates a new instance of DespesaCategoriaBean
     */
    @EJB

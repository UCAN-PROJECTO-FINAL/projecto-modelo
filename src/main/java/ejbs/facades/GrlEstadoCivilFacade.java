...
public class GrlEstadoCivilFacade extends AbstractFacade<GrlEstadoCivil>
{
    ...
    public List<GrlEstadoCivil> findEstadoCivilByDescricao(String estadocivil)
    {
        Query q = em.createQuery("SELECT c FROM GrlEstadoCivil c WHERE c.nome =:estadocivil");
        q.setParameter("estadocivil", estadocivil);
        q.setMaxResults(1);

...
public class FrtTransporteAgendarFacade extends AbstractFacade<FrtTransporteAgendar>
{
    ...
    public List<FrtTransporteAgendar> findAllManutencao()
    {
        Query query = em.createQuery("SELECT m FROM FrtTransporteAgendar m WHERE m.fkTipoAgendamento.descricao = :tipoagendamento1 AND m.isAgendado = true");
        query.setParameter("tipoagendamento1", "Manutenção");
        //query.setParameter("tipoagendamento2", "Local");
        //query.setParameter("estado", "true");
        List<FrtTransporteAgendar> result = query.getResultList();
        return result;
     ...
     public List<FrtTransporteAgendar> findAllAbastecimento()
    {
        Query query = em.createQuery("SELECT m FROM FrtTransporteAgendar m WHERE m.fkTipoAgendamento.descricao = :tipoagendamento1 AND m.isAgendado = true");
        query.setParameter("tipoagendamento1", "Abastecimento");
        //query.setParameter("tipoagendamento2", "Local");
        //query.setParameter("estado", "true");
        List<FrtTransporteAgendar> result = query.getResultList();
        return result;

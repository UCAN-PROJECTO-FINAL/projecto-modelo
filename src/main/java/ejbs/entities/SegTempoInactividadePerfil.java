 ...
 */
@Entity
@Table(name = "seg_tempo_inactividade_perfil", catalog = "sig_ucan_db", schema = "public")
@NamedQueries(
{
...
public class SegTempoInactividadePerfil implements Serializable
{
    ...
    @NotNull
    @Column(name = "pk_seg_tempo_inactividade_perfil", nullable = false)
    private Integer pkSegTempoInactividadePerfil;
    @Basic(optional = false)
    @NotNull
    @Column(name = "fk_seg_perfil", nullable = false)

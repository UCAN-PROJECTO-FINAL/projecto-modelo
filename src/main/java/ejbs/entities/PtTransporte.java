 ...
 */
@Entity
@Table(name = "pt_transporte", catalog = "sig_ucan_db", schema = "public")
@NamedQueries(
{
...
public class PtTransporte implements Serializable
{
    ...
    @NotNull
    @Column(name = "pk_pt_transporte", nullable = false)
    ...
    @NotNull
    @Size(min = 1, max = 50)
    @Column(name = "numero_motor", nullable = false, length = 50)
    private String numeroMotor;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 50)
    @Column(name = "numero_chassi", nullable = false, length = 50)
    ...
    @Size(max = 100)
    @Column(name = "notas_adicionais", length = 100)
